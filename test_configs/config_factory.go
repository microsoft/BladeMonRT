...
func (factory TestConfigFactory) GetConfig() configs.Config {
	return configs.Config{WorkflowFile: TEST_WORKFLOW_FILE, ScheduleFile: TEST_SCHEDULE_FILE, LoggingFile: TEST_LOGGING_FILE, MaxAgeToProcessWinEvtsInDays: TEST_MAX_AGE_TO_PROCESS_WIN_EVTS_IN_DAYS}
}
